//ejemplo de push desde repositorio local rama desarrollo a repositorio remoto rama desarrollo 
using System;
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Customers != null ? 
                View(await _context.Customers.ToListAsync()) :  Problem("Entidad 'NorthwindContext.Customers'  es null.");
        }
